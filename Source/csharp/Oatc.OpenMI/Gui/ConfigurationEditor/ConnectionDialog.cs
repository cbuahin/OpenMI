    ...
    public partial class ConnectionDialog : Form
    {
        ...
        void treeViewTargets_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            if (e.Node != null && e.Node.Tag != null)
            {
                ...
                if (treeViewSources.SelectedNode != null && treeViewSources.SelectedNode.Checked)
                {
                    SetValidAdatedOutputs(treeViewSources.SelectedNode);
                }
            }
            else
                propertyGridConnection.SelectedObject = null;
        ...
        void treeViewSources_AfterCheck(object sender, TreeViewEventArgs e)
        {
            ...
            if (e.Node.Tag != null)
            {
                if (e.Node.Checked)
                {
                    ...
                    treeViewSources.SelectedNode = e.Node;
                    SetValidAdatedOutputs(e.Node);
                }
                else
                {
        ...
        void UpdateCurrentLink()
        {
            ...
            if(inputs.Count == 1)
            {
                if (outputs.Count != 1 && !(inputs[0].ExchangeItem is IBaseMultiInput))
                {
